...
namespace Student_Hostel_Management_System.View
{
    public partial class UserOperationForm : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            RoleType selectedRole = (RoleType)cmbRole.SelectedItem;

            if (selectedRole == RoleType.Admin && loggedInUser.Role != RoleType.Admin)
            {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Password must be a valid number.");
                return;
            }
